...
<body>
    ...
    <footer>
        <div class="container">
            <p>&copy; <?= date('Y') ?> 160STORE. Tất cả các quyền được bảo lưu.</p>
        </div>
    </footer>
    ...
    <!-- Script to ensure proper tab is shown on page load -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Check if there's a hash in the URL to set active tab
            if (window.location.hash === '#register') {
                const registerTabEl = new bootstrap.Tab(document.getElementById('register-tab'));
                registerTabEl.show();
            }

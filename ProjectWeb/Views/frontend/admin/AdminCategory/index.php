                    ...
                    <div class="filter-row d-flex flex-row flex-wrap gap-2 align-items-center">
                        <div class="filter-item flex-grow-1" style="min-width:220px;">
                            <div class="search-box">
                                ...
                                <input type="text" placeholder="Tìm kiếm danh mục..." id="searchCategoryInput"
                                    class="form-control" style="width:100%;padding-left:36px;" autocomplete="off">
                            </div>
                        </div>
                        <div class="filter-item">
                            <select class="filter-dropdown form-select" id="filterStatus">
                                ...
                                <option value="newest" <?= ($status ?? '') == 'newest' ? 'selected' : '' ?>>Mới nhất
                                </option>
                                <option value="oldest" <?= ($status ?? '') == 'oldest' ? 'selected' : '' ?>>Cũ nhất
                                </option>
                            </select>
                        </div>
                        <div class="filter-item">
                            <select class="filter-dropdown form-select" id="sortCategory">
                                ...
                                <option value="name-asc" <?= ($sort ?? '') == 'name-asc' ? 'selected' : '' ?>>Tên (A-Z)
                                </option>
                                <option value="name-desc" <?= ($sort ?? '') == 'name-desc' ? 'selected' : '' ?>>Tên (Z-A)
                                </option>
                            </select>
                        </div>
                    </div>
                                ...
                                <tr data-category-id="<?= $category['ID'] ?>">
                                    ...
                                    <td>
                                        <?php if (!empty($category['image'])): ?>
                                            <img src="<?= htmlspecialchars($category['image']) ?>" alt="Ảnh"
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <button class="btn btn-sm btn-primary btn-edit-category" title="Sửa"
                                                data-id="<?= $category['ID'] ?>">
                        ...
                        <ul class="pagination justify-content-center">
                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                <li class="page-item <?= $i == $currentPage ? 'active' : '' ?>">
                                    <a class="page-link"
                                        href="index.php?controller=admincategory&status=<?= urlencode($status ?? '') ?>&sort=<?= urlencode($sort ?? '') ?>&page=<?= $i ?>"><?= $i ?></a>
                                </li>
                            <?php endfor; ?>
                        </ul>
                    </nav>

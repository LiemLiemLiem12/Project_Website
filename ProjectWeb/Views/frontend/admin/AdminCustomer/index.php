    ...
    <div class="filter-row d-flex flex-row flex-wrap gap-2 align-items-center">
        <div class="filter-item flex-grow-1" style="min-width:220px;">
            <div class="search-box">
                ...
                <input type="text" placeholder="Tìm kiếm tài khoản admin..." id="searchCustomerInput" style="width:100%;padding-left:36px;" autocomplete="off">
            </div>
        </div>
                ...
                <div class="customer-filters mb-3">
                    <div class="filter-row d-flex flex-row flex-wrap gap-2 align-items-center">
                        <div class="filter-item flex-grow-1" style="min-width:220px;">
                            <div class="search-box">
                                <i class="fas fa-search"></i>
                                <input type="text" placeholder="Tìm kiếm khách hàng..." id="searchUserInput" style="width:100%;padding-left:36px;" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>

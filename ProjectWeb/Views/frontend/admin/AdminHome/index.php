...
<head>
    ...
    <style>
        ...
        .section-body, .banner-body {
            padding: 15px;
        }
        .section-footer, .banner-footer {
            padding: 15px;
...
.section-card:hover, .banner-card:hover {
...
@media (max-width: 768px) {
    ...
    .section-footer .btn-group, .banner-footer .btn-group {
        width: 100%;
    }
}
        ...
        <div class="main-content">
            ...
            <div class="content" id="content-container">
                ...
                <ul class="nav nav-tabs" id="homeManagementTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="banners-tab" data-bs-toggle="tab" data-bs-target="#banners-content" type="button" role="tab" aria-controls="banners-content" aria-selected="false">
                            <i class="fas fa-images me-2"></i>Banners
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="policies-tab" data-bs-toggle="tab" data-bs-target="#policies-content" type="button" role="tab" aria-controls="policies-content" aria-selected="false">
                            <i class="fas fa-file-alt me-2"></i>Chính sách
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="social-media-tab" data-bs-toggle="tab" data-bs-target="#social-media-content" type="button" role="tab" aria-controls="social-media-content" aria-selected="false">
                ...
                <div class="tab-content" id="homeManagementTabsContent">
                                ...
                                <?php foreach ($banners as $banner): ?>
                                    <div class="banner-card" data-id="<?= $banner['id'] ?>">
                                        <div class="banner-header d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <span class="status-badge <?= $banner['hide'] == 0 ? 'status-active' : 'status-inactive' ?>">
                                                    <?= $banner['hide'] == 0 ? 'Đang hiển thị' : 'Đã ẩn' ?>
                                                </span>
                                                <span class="date-badge">
                                                    <?= date('d/m/Y', strtotime($banner['start_date'])) ?> - <?= date('d/m/Y', strtotime($banner['end_date'])) ?>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="banner-body">
                                            <img src="<?= $banner['image_path'] ?>" alt="<?= htmlspecialchars($banner['title']) ?>" class="banner-preview">
                                            <p class="text-center mb-0"><a href="<?= $banner['link'] ?>" target="_blank" class="text-decoration-none"><?= $banner['link'] ?></a></p>
                                        </div>
                                        <div class="banner-footer">
                                            ...
                                            <div>
                                                <button class="btn btn-sm btn-outline-secondary btn-edit-banner" data-id="<?= $banner['id'] ?>">
                                                    <i class="fas fa-edit me-1"></i>Sửa
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger btn-delete-banner" data-id="<?= $banner['id'] ?>">
                                                    <i class="fas fa-trash me-1"></i>Xóa
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <?php foreach ($policies as $policy): ?>
                                    <div class="section-card" data-id="<?= $policy['id'] ?>">
                                        <div class="section-header d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <?php if (!empty($policy['image'])): ?>
                                                    <img src="<?= $policy['image'] ?>" alt="<?= htmlspecialchars($policy['title']) ?>" class="me-2" style="width: 30px; height: 30px; object-fit: cover;">
                                                <?php else: ?>
                                            ...
                                            <div>
                                                <span class="status-badge <?= $policy['hide'] == 0 ? 'status-active' : 'status-inactive' ?>">
                                        ...
                                        <div class="section-footer">
                                            ...
                                            <div>
                                                <button class="btn btn-sm btn-outline-secondary btn-edit-policy" data-id="<?= $policy['id'] ?>">
                                                    <i class="fas fa-edit me-1"></i>Sửa
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger btn-delete-policy" data-id="<?= $policy['id'] ?>">
                                                    <i class="fas fa-trash me-1"></i>Xóa
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <!-- Social Media Tab -->
                    <div class="tab-pane fade" id="social-media-content" role="tabpanel" aria-labelledby="social-media-tab">
                        <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <div class="section-card" data-id="<?= $socialMedia['id'] ?>">
                                        <div class="section-card-header">
                                            ...
                                            <div>
                                                ...
                                                <?php endif; ?>
                                                <button class="btn btn-sm btn-outline-primary ms-1 btn-edit-social-media" data-id="<?= $socialMedia['id'] ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger ms-1 btn-delete-social-media" data-id="<?= $socialMedia['id'] ?>">
                                        ...
                                        <div class="section-card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-11">
                                                    <div class="mb-2">
                                                        <strong>Icon:</strong> <code><?= htmlspecialchars($socialMedia['icon']) ?></code>
                                                    </div>
                                                    <div class="mb-2">
                                                        <strong>Link:</strong> <a href="<?= $socialMedia['link'] ?>" target="_blank"><?= $socialMedia['link'] ?></a>
                                                    </div>
                                                    <div>
                                                        <strong>Mô tả:</strong> <?= nl2br($socialMedia['meta'] ?? 'Không có mô tả') ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="payment-methods-content" role="tabpanel" aria-labelledby="payment-methods-tab">
                        ...
                        <div id="paymentMethodsContainer">
                            <?php if (empty($paymentMethods)): ?>
                                <div class="alert alert-info">Chưa có phương thức thanh toán nào. Hãy thêm phương thức thanh toán mới.</div>
                            <?php else: ?>
                                <?php foreach ($paymentMethods as $paymentMethod): ?>
                                    <div class="section-card" data-id="<?= $paymentMethod['id'] ?>">
                                        <div class="section-card-header">
                                            ...
                                            <div>
                                                ...
                                                <?php else: ?>
                                                    <span class="badge bg-success"><i class="fas fa-check-circle me-1"></i>Hiển thị</span>
                                                <?php endif; ?>
                                                <button class="btn btn-sm btn-outline-primary ms-1 btn-edit-payment-method" data-id="<?= $paymentMethod['id'] ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger ms-1 btn-delete-payment-method" data-id="<?= $paymentMethod['id'] ?>">
                                                    <i class="fas fa-trash-alt"></i>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="section-card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <img src="<?= $paymentMethod['image'] ?>" class="img-fluid rounded" alt="<?= $paymentMethod['title'] ?>">
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="mb-2">
                                                        <strong>Link:</strong> <a href="<?= $paymentMethod['link'] ?>" target="_blank"><?= $paymentMethod['link'] ?></a>
                                                    </div>
                                                    <div>
                                                        <strong>Mô tả:</strong> <?= nl2br($paymentMethod['meta'] ?? 'Không có mô tả') ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-body">
                    <form id="addSectionForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="product_count" name="product_count" value="4" min="1" max="20">
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-body">
                    <form id="editSectionForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="edit_product_count" name="product_count" min="1" max="20">
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="card-body">
                                <form id="addItemForm" class="row g-3">
                                    ...
                                    <div class="col-md-12 text-end">
                                        <button type="button" class="btn btn-sm btn-secondary" id="cancelAddItem">Hủy</button>
                                        <button type="button" class="btn btn-sm btn-primary" id="confirmAddItem">Thêm</button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addBannerForm" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="banner_title" class="form-label">Tiêu đề <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="banner_title" name="title" required>
                        </div>
                        <div class="mb-3" id="image_upload_container">
                            <label for="bannerImage" class="form-label">Ảnh banner <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" id="bannerImage" name="image_upload" accept="image/*" required>
                        ...
                        <div id="cropperContainer" style="display: none;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-outline-secondary" data-method="scaleX" data-option="-1">
                                        <i class="fas fa-arrows-alt-h"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline-secondary" data-method="scaleY" data-option="-1">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="banner_start_date" name="start_date" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                            <div class="col">
                                <label for="banner_end_date" class="form-label">Ngày kết thúc</label>
                                <input type="date" class="form-control" id="banner_end_date" name="end_date" value="<?php echo date('Y-m-d', strtotime('+30 days')); ?>">
                            </div>
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editBannerForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                            <label for="edit_banner_title" class="form-label">Tiêu đề <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3" id="edit_image_upload_container">
                            ...
                            <input type="file" class="form-control" id="edit_banner_image" name="image_upload" accept="image/*">
                            <div class="form-text">Kích thước đề xuất: 1200x400 pixel, tối đa 2MB. Để trống nếu không thay đổi ảnh.</div>
                        <div class="mt-2">
                            <img id="editBannerPreview" src="" alt="Preview" style="max-width: 100%; max-height: 200px; display: none;">
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                            <label for="social_media_title" class="form-label">Tên mạng xã hội <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="social_media_title" name="title" required>
                        </div>
                        <div class="mb-3">
                            <label for="social_media_icon" class="form-label">Icon <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="social_media_icon" name="icon" required placeholder="fab fa-facebook">
                                <button type="button" class="btn btn-outline-secondary icon-picker-btn" data-target="social_media_icon">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="social_media_status" name="status" checked>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                            <label for="edit_social_media_title" class="form-label">Tên mạng xã hội <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="edit_social_media_title" name="title" required>
                        </div>
                        <div class="mb-3">
                            <label for="edit_social_media_icon" class="form-label">Icon <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="text" class="form-control" id="edit_social_media_icon" name="icon" required>
                                <button type="button" class="btn btn-outline-secondary icon-picker-btn" data-target="edit_social_media_icon">
                                    <i class="fas fa-icons"></i> Chọn icon
                                </button>
                            </div>
                            <div class="form-text">Ví dụ: fab fa-facebook, fab fa-instagram,...</div>
    ...
    <div class="modal fade" id="addPaymentMethodModal" tabindex="-1" aria-labelledby="addPaymentMethodModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addPaymentMethodForm" enctype="multipart/form-data" method="post" action="javascript:void(0);">
                    <div class="mb-3">
                            <label for="payment_method_title" class="form-label">Tên phương thức <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3" id="payment_method_image_container">
                            <label for="payment_method_image" class="form-label">Ảnh <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" id="payment_method_image" name="image_upload" accept="image/*" required>
                    ...
                    <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="payment_method_status" name="status" checked>
    ...
    <div class="modal fade" id="editPaymentMethodModal" tabindex="-1" aria-labelledby="editPaymentMethodModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editPaymentMethodForm" enctype="multipart/form-data" method="post" action="javascript:void(0);">
                        <input type="hidden" id="edit_payment_method_id" name="id">
                        <div class="mb-3">
                            <label for="edit_payment_method_title" class="form-label">Tên phương thức <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="edit_payment_method_title" name="title" required>
                        </div>
                        <div class="mb-3" id="edit_payment_method_image_container">
                            <label for="edit_payment_method_image" class="form-label">Ảnh</label>
                            <input type="file" class="form-control" id="edit_payment_method_image" name="image_upload" accept="image/*">
                            <div class="form-text">Để trống nếu không muốn thay đổi ảnh hiện tại, tối đa 1MB</div>
                            <div class="mt-2">
                                <img id="editPaymentMethodPreview" src="" alt="Preview" style="max-width: 100%; max-height: 200px; display: none;">
                            </div>
                        </div>
                        ...
                        <div id="edit_payment_method_cropperContainer" style="display: none;">
                            ...
                            <div class="text-center mb-3">
                                ...
                                <button type="button" class="btn btn-outline-secondary" id="editCancelPaymentMethodCropBtn">
                                    <i class="fas fa-times"></i> Hủy
                                </button>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="edit_payment_method_meta" name="meta" rows="2"></textarea>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="edit_payment_method_status" name="status">

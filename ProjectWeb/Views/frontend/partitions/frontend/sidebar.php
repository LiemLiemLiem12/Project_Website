...
<div class="sidebar" id="sidebar">
    <style>
        ...
        .sidebar .nav-links li:nth-child(1) { --item-index: 1; }
        .sidebar .nav-links li:nth-child(2) { --item-index: 2; }
        .sidebar .nav-links li:nth-child(3) { --item-index: 3; }
        .sidebar .nav-links li:nth-child(4) { --item-index: 4; }
        .sidebar .nav-links li:nth-child(5) { --item-index: 5; }
        .sidebar .nav-links li:nth-child(6) { --item-index: 6; }
        .sidebar .nav-links li:nth-child(7) { --item-index: 7; }
        .sidebar .nav-links li:nth-child(8) { --item-index: 8; }

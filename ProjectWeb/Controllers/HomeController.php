...
class HomeController extends BaseController
{
    ...
    public function index()
    {
        ...
        $mostViewProducts = $this->productModel->getAll(['id_Product', 'name', 'img', 'current_price', 'description'], 4, ['column' => 'click_count', 'order' => 'desc']);
        $mostSaleProducts = $this->productModel->getAll(['id_Product', 'name', 'img', 'current_price', 'description'], 4, ['column' => 'sale', 'order' => 'desc']);
